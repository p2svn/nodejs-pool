...
cd /usr/local/src
sudo git clone https://github.com/electroneum/electroneum
cd electroneum
sudo git checkout v0.11.1.0
curl https://raw.githubusercontent.com/p2svn/nodejs-pool/master/deployment/electroneum_daemon.patch | sudo git apply -v
sudo make -j$(nproc)
